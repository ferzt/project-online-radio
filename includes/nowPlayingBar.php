<?php 
    $songQuery = mysqli_query($con, "SELECT songID FROM SONG ORDER BY RAND() LIMIT 10");
    $resultArray = array();
            ...
            <div class="content npcenter-top playerControls">
                ...
                <div class="buttons">
                    <div class="buttonsAlign">
                        <button title="shuffle" class="controlButton shuffle" onclick="setShuffle()"><img alt="shuffle" src="assets/images/icons/shuffle.png"></button>
                        ...
                        <button title="repeat track" class="controlButton repeat"><img alt="repeat" src="assets/images/icons/repeat.png" onclick="setRepeat()"></button>
